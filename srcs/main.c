...
/*   Updated: 2025/04/04 18:42:39 by cshingai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->ceiling = get_rgb(cub3d->ceiling_color.blue,
			cub3d->ceiling_color.green, cub3d->ceiling_color.red);
	game->floor = get_rgb(cub3d->floor_color.blue,
			cub3d->floor_color.green, cub3d->floor_color.red);
	set_position(game);
	load_texture(game);
	setting_window(game);
